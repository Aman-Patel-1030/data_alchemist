  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            <Target className="h-5 w-5 bg-gradient-to-br from-primary to-black text-white" />
        ...
        <CardContent>
          <Tabs defaultValue="weights" className="space-y-4">
            ...
            <TabsContent value="weights" className="space-y-6">
              {/* Weight Status */}
              <div className="flex items-center justify-between p-4 bg-white text-black border rounded-lg">
                <div>
                ...
                <div className="text-right ">
                  ...
                  <Badge className="bg-gradient-to-br from-primary to-black text-white" variant={isBalanced ? "default" : "destructive"}>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            <BarChart3 className="h-5 w-5 bg-gradient-to-br from-primary to-black text-white" />
            ...
            {state.priorities.map((priority) => (
              <div key={priority.id} className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="bg-gradient-to-br from-primary to-black text-white h-2 rounded-full transition-all duration-300"
