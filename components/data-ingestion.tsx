...
export default function DataIngestion() {
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-center justify-center w-full">
            <Label
              htmlFor={`${type}-upload`}
              className="flex flex-col items-center justify-center w-full h-32 border-2  border-gray-300 rounded-lg cursor-pointer bg-gradient-to-br from-primary to-black text-white hover:black transition-colors "
            >
  ...
  return (
    <div className="space-y-8 " style={{minHeight:"80vh"}} >
       ...
       <div>
        <h1 className="text-3xl font-bold flex items-center justify-center">Data Upload</h1>
        <p className=" pb-5 text-muted-foreground flex items-center justify-center">Upload your CSV or XLSX files with AI-enhanced parsing and validation</p>
      </div>
      ...
      {/* AI Features Info */}
      <Card className="bg-gradient-to-br from-primary to-black text-white">
        <CardHeader>
          <div className="flex items-center gap-2">
                      <Image
        src="/ai.png" // relative to /public
        alt="Logo"
        width={25}
        height={25}
