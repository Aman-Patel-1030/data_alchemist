    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          />
          <Button className = "bg-gradient-to-br from-primary to-black text-white" onClick={handleSearch} disabled={isSearching}>
            {isSearching ? <Loader2 className="bg-gradient-to-br from-primary to-black text-white h-4 w-4 animate-spin" /> : <Search className="h-4 w-4 " />}
          </Button>
        </div>
            ...
            <ScrollArea className="h-32">
              <div className="space-y-1">
                {state.searchResults.map((result, index) => (
                  <div key={index} className="flex items-center gap-2 p-2 rounded bg-white text-black ">
