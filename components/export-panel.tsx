      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2  ">
            <Package className="h-5 w-5 bg-gradient-to-br from-primary to-black text-white" />
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Badge className = "bg-gradient-to-br from-primary to-black text-white"variant={hasErrors ? "destructive" : "default"}>
          ...
          {/* Export Button */}
          <Button  onClick={handleExport} disabled={!hasData || isExporting} className="w-full bg-gradient-to-br from-primary to-black text-white" size="lg">
            {isExporting ? (
              <>
