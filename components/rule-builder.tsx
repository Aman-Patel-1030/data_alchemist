      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            <Settings className="h-5 w-5 bg-gradient-to-br from-primary to-black text-white" />
        ...
        <CardContent>
          <Tabs defaultValue="manual" className="space-y-4">
            ...
            <TabsContent value="manual" className="space-y-4">
              ...
              <Button onClick={addRule} className="w-full bg-gradient-to-br from-primary to-black text-white">
            ...
            <TabsContent value="ai" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-br from-primary to-black text-white"
                >
                  {isProcessingNL ? (
                    <>
                ...
                <div className=" bg-gradient-to-br from-primary to-black text-white p-4 rounded-lg">
                  <h4 className="font-medium text-white mb-2">AI Rule Examples:</h4>
